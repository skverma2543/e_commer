...
<div id="hero" class="homepage-slider3 " style="margin-buttom:0px;">
  ...
  background-image: url('assets/images/sliders/myslider/slider5.png');
...
">
		...
		<div class="full-width-slider">	
		<div class="item" style="
  background-image: url('assets/images/sliders/myslider/slider7.png');
  background-repeat: no-repeat;
  background-size: contain;
  background-position: center;
  height: 350px;  /* Adjust height as per image ratio */
">
		...
		<div class="full-width-slider">	
		<div class="item" style="
  background-image: url('assets/images/sliders/myslider/slider8.png');
  background-repeat: no-repeat;
  background-size: contain;
  background-position: center;
  height: 350px;  /* Adjust height as per image ratio */
