...
if(isset($_POST['submit'])){
		...
		$_SESSION['msg'] = "Your cart has been updated!";
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<button type="submit" name="remove_code_submit" class="btn btn-upper btn-primary pull-right outer-right-xs" style="margin-right:4px">
		...
		<tbody>
				<tr>
					<td>
						...
						<button type="submit" name="ordersubmit" class="btn btn-success btn-lg checkout-page-button">
