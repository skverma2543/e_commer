		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">Invoice</th>
...
?>
				<tr>
					...
					<td class="cart-product-sub-total"><?php echo htmlentities($row['ostatus']); ?>  </td>
					<td>
  <a href="invoice.php?oid=<?php echo htmlentities($row['orderid']); ?>" target="_blank">Download</a>
</td>
